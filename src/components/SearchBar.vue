<template>
  <div id="search-bar" class="el-tertiary">
    <button class="button-plain align" @click="searchWithKeyword"><img src="../assets/ic_search@3x.png" class="search-icon"></button>
    ...
    <button class="button-plain align" @click="clearInput"><img src="../assets/ic_clear@3x.png" class="search-icon"></button>
  </div>
</template>
